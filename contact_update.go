...
type ContactUpdate_Request struct {
...
//FILTER => All fields from Struct: gofastbill.ContactUpdate_Request
//Required: CONTACT_ID
//Response: STATUS, CONTACT_ID
func (s *Initialization) Contact_update(req ContactUpdate_Request) (*FBAPI, error) {

	var fastbillbody string

	var r FBAPI

	r.SERVICE = "contact.update"

	if req.CONTACT_ID == "" {

		return nil, errors.New(s.Typ + ": Missing CONTACT_ID, must not be empty.")
